...
class Response
{
	...
	/**
	 * An array of HTTP status codes and messages.
	 * @var array
	 */
	...
	{
		$this->compress		= Registry::get('Settings')->getParam('http_compression_level');
	 ...
	 * @param int $code
	 */
	public function sendHttpStatusCode($code = false)
	{
		$code ? header($this->getHeaderStatus($code)) : header($this->getHeaderStatus($this->status_code));		
	}
