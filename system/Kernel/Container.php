...
class Container extends Base
{
	 ...
	 * __SAMPLE_USE
	 */
	protected function __SAMPLE_USE()
	{
		...
		// Получить данные о контейнере.
		$Container->getData($container_id);
		
		// Получить полный список контейнеров.
		$Container->getList();
		
		// Получение данных для формирования формы создания новой папки.
		$Container->getCreateFormData($container_id);
		
		// Получение данных для формирования формы редактирования папки.
		$Container->getEditFormData($container_id);
	}
