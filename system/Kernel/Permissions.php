<?php
/**
 * Класс работы с правами доступа для папок и нод (и видимо для модулей).
 * 
 ...
 */
class Permissions extends SingletonBase
{
	...
	public function isAllowed($object, $action, $permissions, $user_id = null) 
	{
		...
		if (isset($permissions) and strlen($permissions) > 0) {
			...
			// cf_debug($permissions, 'массив permissions после разбора строки');
